package zdoctor.lazymodder.api;
...
public class IItemRendererAPI {
	...
	static {
		try {
			registerIItemRenderer = Class.forName("zdoctor.lazymodder.client.render.IItemRendererHandler").getMethod("registerIItemRenderer", Item.class, IItemRenderer.class);
		} catch(Exception e){
			e.printStackTrace();
