...
import zdoctor.lazymodder.easy.items.EasyItemMultiBlockTileEntity;

public class EasyMultiBlockTileEntityBlock extends EasyBlock implements ITileEntityProvider, IEasyTileEntity, IEasyRegister {
	protected Class<? extends TileEntity> tileEntity;

	public EasyMultiBlockTileEntityBlock(String name, Class<? extends TileEntity> tileEntity) {
		this(name, tileEntity, Material.IRON);
	}

	public EasyMultiBlockTileEntityBlock(String name, Class<? extends TileEntity> tileEntity, Material materialIn) {
	...
	public ItemBlock createItem() {
		return new EasyItemMultiBlockTileEntity(this);
	}
