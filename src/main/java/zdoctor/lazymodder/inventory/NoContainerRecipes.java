package zdoctor.lazymodder.inventory;
...
public class NoContainerRecipes extends ShapedRecipes {

		private ItemStack container = ItemStack.EMPTY;

		public NoContainerRecipes(int width, int height, ItemStack[] ingredientsIn, ItemStack output) {
