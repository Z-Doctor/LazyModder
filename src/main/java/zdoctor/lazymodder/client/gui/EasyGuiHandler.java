 ...
 * but can be fetched from the class. Only one GuiHandler per mod. To change your
 * gui based on player position, create a constructor for 
 * EntityPlayer player, World world, int x, int y, int z
 */
public class EasyGuiHandler implements IGuiHandler, IEasyGuiHandler {
//	protected static final Map<Mod, EasyGuiHandler> GUI_HANDLERS = new HashMap<>();
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if(serverGui == null)
			return null;
		try {
			Constructor<? extends GuiContainer> constructor = serverGui.getConstructor(EntityPlayer.class, World.class, Integer.class, Integer.class, Integer.class);
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if(clientGui == null)
			return null;
		try {
			Constructor<? extends GuiScreen> constructor = clientGui.getConstructor(EntityPlayer.class, World.class, Integer.class, Integer.class, Integer.class);
			return constructor.newInstance(player, world, x, y , z);
		} catch (Exception e) {
			try {
