...
public class Entity {
	public static void preInit() {
		...
		// EasyLivingEntity testEntity3 = new
		// EasyLivingEntity(TestSpiderGolem.class,
		// TestSpiderGolem.RenderSpiderGoldem.class, "Test3").addEgg(0,
		// 16777215);

//		EasyLivingEntity mushroomoid = new EasyLivingEntity(EntityMushromoid.class, RenderMushromid.class, "Mushromoid", 0, 16777215);
	}
}
